...
public class AliyunUtil {
    ...
    private static String accessKeyId = "LTAI5tM6yvD5MczvPrHv1KAk";
    private static String accessKeySecret = "eo4sssFJUJkkV1JAtr41ejQyuwn5QW";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "cbb-shanjupay1";
     ...
     * @param fileName 文件名称
     */
    public static void upload(String endpoint, String accessKeyId, String accessKeySecret, String bucketName, byte[] bytes, String fileName)throws RuntimeException
    {
        ...
        try {
            ...
            LOGGER.error("Caught an OSSException, which means your request made it to OSS,",oe.getErrorMessage());
            throw new RuntimeException(oe.getErrorMessage());
        } catch (ClientException ce) {
            LOGGER.error("Caught an ClientException, which means the client encountered "
                    + "a serious internal problem while trying to communicate with OSS",ce.getMessage());
            throw new RuntimeException(ce.getErrorMessage());
        }
